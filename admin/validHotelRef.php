...
<?php }
elseif(!empty($_GET["success"]) && $_GET["success"] == "acc"){?>
    <div class="alert alert-warning">La demande a bien été supprimée !</div>
<?php }
...
<div class="container">
    <?php if(count($hea) > 0){ ?>
        <h1 class="mb-5">Demande d'ajout d'hébergement refusée :</h1>
                        ...
                        foreach($hea as $demande){
                            ...
                            <tr>
                                ...
                                <td class="btn-group d-flex" >
                                    ...
                                    <a href="../controleurs/demandeHebergement.php?id=<?=$demande["id_admin_valid_hebergement"]?>&command=sup" class="btn btn-danger">Supprimer</a>
                                </td>
                            </tr>
                            <?php
                        }
